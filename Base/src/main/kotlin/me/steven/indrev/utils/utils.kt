...
fun itemSettings(): FabricItemSettings = FabricItemSettings().group(GROUP)
...
fun Identifier.screenHandlerType(type: ScreenHandlerType<*>): Identifier {
    Registry.register(Registry.SCREEN_HANDLER, this, type)
    return this
}

fun Identifier.createRecipeType(type: MachineRecipeType): MachineRecipeType {
    Registry.register(Registry.RECIPE_TYPE, this, type)
    Registry.register(Registry.RECIPE_SERIALIZER, this, MachineRecipeSerializer())
    return type
}
