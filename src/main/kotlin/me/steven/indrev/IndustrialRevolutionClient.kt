...
object IndustrialRevolutionClient : ClientModInitializer {
    override fun onInitializeClient() {
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(IRBlockRegistry.ITEM_PIPE_MK1, RenderLayer.getCutout())
        BlockRenderLayerMap.INSTANCE.putBlock(IRBlockRegistry.ITEM_PIPE_MK2, RenderLayer.getCutout())
        BlockRenderLayerMap.INSTANCE.putBlock(IRBlockRegistry.ITEM_PIPE_MK3, RenderLayer.getCutout())
        BlockRenderLayerMap.INSTANCE.putBlock(IRBlockRegistry.ITEM_PIPE_MK4, RenderLayer.getCutout())
        BlockRenderLayerMap.INSTANCE.putBlock(IRBlockRegistry.FLUID_PIPE_MK1, RenderLayer.getCutout())
        BlockRenderLayerMap.INSTANCE.putBlock(IRBlockRegistry.FLUID_PIPE_MK2, RenderLayer.getCutout())
        BlockRenderLayerMap.INSTANCE.putBlock(IRBlockRegistry.FLUID_PIPE_MK3, RenderLayer.getCutout())
        BlockRenderLayerMap.INSTANCE.putBlock(IRBlockRegistry.FLUID_PIPE_MK4, RenderLayer.getCutout())
