...
open class ElectricBlock(settings: Settings, private val screenId: Identifier, val maxBuffer: Double, private val test: (BlockEntity?) -> Boolean, val blockEntityProvider: () -> ElectricBlockEntity) : Block(settings), BlockEntityProvider {
