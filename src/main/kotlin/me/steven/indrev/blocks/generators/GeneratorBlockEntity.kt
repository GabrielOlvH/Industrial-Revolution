...
abstract class GeneratorBlockEntity(type: BlockEntityType<*>, private val generationRatio: Double, tier: EnergyTier)
    : ElectricBlockEntity(type, tier), Tickable, InventoryProvider {
