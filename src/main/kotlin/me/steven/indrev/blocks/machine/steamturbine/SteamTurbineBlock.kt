...
class SteamTurbineBlock(registry: MachineRegistry, settings: Settings) : HorizontalFacingMachineBlock(registry, settings, Tier.MK4, IRConfig.generators.steamTurbine, null) {
