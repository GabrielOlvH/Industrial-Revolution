...
class CondenserRecipeCategory(
    private val identifier: Identifier,
    private val logo: EntryStack,
    private val categoryName: String
) : TransferRecipeCategory<CondenserMachinePlugin> {
    ...
    override fun setupDisplay(recipeDisplay: CondenserMachinePlugin, bounds: Rectangle): MutableList<Widget> {
        val startPoint = Point(bounds.centerX - 41, bounds.centerY - 27)
