...
class MultiblockMatcher constructor(val blockEntity: MachineBlockEntity<*>, val structure: Map<BlockPos, BlockState>)
    ...
    class Builder(val test: MutableMap<BlockPos, BlockState> = HashMap()) {
        ...
        fun build(blockEntity: MachineBlockEntity<*>) = MultiblockMatcher(blockEntity, ImmutableMap.copyOf(test))
    }
}