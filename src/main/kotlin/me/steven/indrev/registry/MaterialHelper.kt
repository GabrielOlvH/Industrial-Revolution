...
class MaterialHelper(private val id: String, private val block: MaterialHelper.() -> Unit) {
    ...
    companion object {
        ...
        init {
            ...
            putBlock("lead_ore", MaterialBakedModel.Builder().ore().oreBase(LEAD_BASE).oreHighlight(LEAD_HIGHLIGHT).build())
            ...
            putBlock("silver_ore", MaterialBakedModel.Builder().ore().oreBase(SILVER_BASE).oreHighlight(SILVER_HIGHLIGHT).build())
            ...
            putBlock("copper_ore", MaterialBakedModel.Builder().ore().oreBase(COPPER_BASE).oreHighlight(COPPER_HIGHLIGHT).build())
            ...
            putBlock("tungsten_ore", MaterialBakedModel.Builder().ore().oreBase(TUNGSTEN_BASE).oreHighlight(TUNGSTEN_HIGHLIGHT).build())
            ...
            putBlock("bronze_ore", MaterialBakedModel.Builder().ore().oreBase(BRONZE_BASE).oreHighlight(BRONZE_HIGHLIGHT).build())
            ...
            putBlock("electrum_ore", MaterialBakedModel.Builder().ore().oreBase(ELECTRUM_BASE).oreHighlight(ELECTRUM_HIGHLIGHT).build())
            ...
            putBlock("steel_ore", MaterialBakedModel.Builder().ore().oreBase(STEEL_BASE).oreHighlight(STEEL_HIGHLIGHT).build())
            ...
            put("tin_ingot", MaterialBakedModel.Builder().ingotBase(TIN_BASE).ingotHighlight(TIN_HIGHLIGHT).ingotOutline(TIN_OUTLINE).build())
            put("tin_plate", MaterialBakedModel.Builder().plateBase(TIN_BASE).plateHighlight(TIN_HIGHLIGHT).plateOutline(TIN_OUTLINE).build())
            put("tin_pickaxe", MaterialBakedModel.Builder().toolStick().pickaxeBase(TIN_BASE).pickaxeHighlight(TIN_HIGHLIGHT).pickaxeOutline(TIN_OUTLINE).build())
            put("tin_axe", MaterialBakedModel.Builder().toolStick().axeBase(TIN_BASE).axeHighlight(TIN_HIGHLIGHT).axeOutline(TIN_OUTLINE).build())
            put("tin_sword", MaterialBakedModel.Builder().toolStick().swordBase(TIN_BASE).swordHighlight(TIN_HIGHLIGHT).swordOutline(TIN_OUTLINE).build())
            put("tin_hoe", MaterialBakedModel.Builder().toolStick().hoeBase(TIN_BASE).hoeHighlight(TIN_HIGHLIGHT).hoeOutline(TIN_OUTLINE).build())
            put("tin_shovel", MaterialBakedModel.Builder().toolStick().shovelBase(TIN_BASE).shovelHighlight(TIN_HIGHLIGHT).shovelOutline(TIN_OUTLINE).build())
            put("tin_helmet", MaterialBakedModel.Builder().helmetBase(TIN_BASE).helmetHighlight(TIN_HIGHLIGHT).helmetOutline(TIN_OUTLINE).build())
            put("tin_dust", MaterialBakedModel.Builder().dustBase(TIN_BASE).dustHighlight(TIN_HIGHLIGHT).dustOutline(TIN_OUTLINE).build())
            put("tin_chestplate", MaterialBakedModel.Builder().chestplateBase(TIN_BASE).chestplateHighlight(TIN_HIGHLIGHT).chestplateOutline(TIN_OUTLINE).build())
            put("tin_boots", MaterialBakedModel.Builder().bootsBase(TIN_BASE).bootsHighlight(TIN_HIGHLIGHT).bootsOutline(TIN_OUTLINE).build())
            put("tin_leggings", MaterialBakedModel.Builder().leggingsBase(TIN_BASE).leggingsHighlight(TIN_HIGHLIGHT).leggingsOutline(TIN_OUTLINE).build())
            ...
            putBlock("tin_ore", MaterialBakedModel.Builder().ore().oreBase(TIN_BASE).oreHighlight(TIN_HIGHLIGHT).build())
            ...
            put("netherite_scrap_purified_ore", MaterialBakedModel.Builder().purifiedOreBase(NETHERITE_SCRAP_BASE).purifiedOreHighlight(NETHERITE_SCRAP_HIGHLIGHT).purifiedOreOutline(NETHERITE_SCRAP_OUTLINE).build())
