...
enum class GamerAxeModule(
    ...
    LOOTING("looting", 3, IRRegistry.LOOTING_MODULE_ITEM),
    FIRE_ASPECT("fire_aspect", 1, IRRegistry.FIRE_ASPECT_MODULE_ITEM),
    SHARPNESS("sharpness", 5, IRRegistry.SHARPNESS_MODULE_ITEM),
    REACH("reach", 4, IRRegistry.SHARPNESS_MODULE_ITEM); // NOT IMPLEMENTED
